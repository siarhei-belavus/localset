...
## Project-Targeted Presets

Presets can be scoped to specific projects. A project-targeted preset only auto-applies when working in that project—other projects continue to use their own defaults.

Assign a preset to one or more projects in **Settings → Terminal** when editing a preset.
